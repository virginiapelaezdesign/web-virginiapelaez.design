...
import { E as p, a as ne, r as m, s as re } from "./motion.C18vkCAc.mjs";
import {
  E as h,
  G as g,
  L as _,
...
var C,
  ...
  ge = e(() => {
    (l(),
      g(),
      d(),
      (F = `url('data:image/svg+xml,<svg display="block" role="presentation" viewBox="0 0 12 20" xmlns="http://www.w3.org/2000/svg"><path d="M 0 0 L 12 0 L 12 6 L 6 6 Z M 0 6 L 6 6 L 12 12 L 6 12 L 6 18 L 0 12 Z" fill="var(--1bd4d3i, rgb(0, 0, 0))" height="18px" id="td4SVg2I8" transform="translate(0 1.5)" width="12px"/></svg>'), var(--framer-icon-mask, none)`),
      (I = `alpha, var(--framer-icon-mask-mode, add)`),
      (L = `no-repeat`),
      (R = `center`),
      (z = `auto`),
      (B = s((e, t) => {
      ...
      (V = ({ fill: e, fill2: t, height: n, id: r, width: i, ...a }) => ({
        ...a,
        vtL2DrqsL: t ?? a.vtL2DrqsL ?? `rgb(0, 0, 0)`,
        Z1QnXqTEb: e ?? a.Z1QnXqTEb ?? `rgb(0, 0, 0)`,
      })),
      (H = v(
        ...
        [
          `.framer-hcsc7 { -webkit-mask-image: ${F}; -webkit-mask-position: ${R}; -webkit-mask-repeat: ${L}; -webkit-mask-size: ${z}; aspect-ratio: 0.6; background-color: var(--1bd4d3i); mask-image: ${F}; mask-mode: ${I}; mask-position: ${R}; mask-repeat: ${L}; mask-size: ${z}; width: 12px; }`,
        ],
        `framer-hcsc7`
      )),
      (H.displayName = `Framer`),
      h(H, {
        Z1QnXqTEb: { defaultValue: `rgb(0, 0, 0)`, hidden: !1, title: `Fill`, type: b.Color },
        vtL2DrqsL: { defaultValue: `rgb(0, 0, 0)`, hidden: !0, title: `Fill 2`, type: b.Color },
      }));
...
e(() => {
  (l(),
    ...
    (U = _(H)),
    (W = _(P)),
    (G = S(P, { nodeId: `pBR1Ew0r8`, override: pe, scopeId: `PX9hIOIVM` })),
    (K = ae(ue(S(p.a, { nodeId: `HK2sXlagE`, override: fe, scopeId: `PX9hIOIVM` })))),
    (q = `framer-6jWyo`),
    (J = { HK2sXlagE: `framer-v-n0ccwk` }),
    (Y = {
      opacity: 1,
      rotate: 0,
      rotateX: 0,
    ...
    (ye = ({ value: e, children: n }) => {
      ...
      return o(re.Provider, { value: a, children: n });
    }),
    (be = p.create(i)),
    ...
    (Q = v(
      s(function (e, t) {
        ...
        se();
        let { style: l, className: u, layoutId: d, variant: f, ...m } = xe(e),
          {
            baseVariant: re,
            classNames: h,
            ...
            setVariant: b,
            variants: x,
          } = oe({ defaultVariant: `HK2sXlagE`, ref: i, variant: f, variantClassNames: J }),
          S = Se(e, x),
          ue = y(q);
        return o(ne, {
          id: d ?? a,
            ...
            children: o(ye, {
              ...
              children: o(ce, {
                ...
                children: c(K, {
                  ...m,
                  ..._,
                  __framer__presenceAnimate: Y,
                  __framer__presenceInitial: X,
                  __perspectiveFX: !1,
                  __smartComponentFX: !0,
                  __targetOpacity: 1,
                  className: `${y(ue, `framer-n0ccwk`, u, h)} framer-bmpgw8`,
    ...
    ie(Q, [{ explicitInter: !0, fonts: [] }, ...U, ...W], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.Cz5Fn8rU.mjs.map
