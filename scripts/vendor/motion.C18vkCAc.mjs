...
function Fe(e, t, n, r, i) {
  let a,
    o,
    s = 0;
  do ((o = t + (n - t) / 2), (a = Ws(o, r, i) - e), a > 0 ? (n = o) : (t = o));
  while (Math.abs(a) > Gs && ++s < Ks);
  return o;
}
function Ie(e, t, n, r) {
  if (e === t && n === r) return I;
  let i = (t) => Fe(t, 0, 1, e, n);
  return (e) => (e === 0 || e === 1 ? e : Ws(i(e), t, r));
}
function Le(e, t) {
  return ac(e) ? e[Us(0, e.length, t)] : e;
}
function Re(e) {
  let t = new Set(),
    n = new Set(),
...
function ze(e, t) {
  let n = !1,
    ...
    h = () => {
      ...
      ((n = !1),
        a || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, dc), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
  ...
  return {
    schedule: uc.reduce((e, t) => {
      let r = o[t];
      return ((e[t] = (e, t = !1, i = !1) => (n || g(), r.schedule(e, t, i))), e);
    }, {}),
    cancel: (e) => {
      for (let t = 0; t < uc.length; t++) o[uc[t]].cancel(e);
    },
    state: i,
    steps: o,
  };
...
function We(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(Cc)?.length || 0) + (e.match(Ic)?.length || 0) > 0
  );
}
function Ge(e) {
  let t = e.toString(),
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          K.test(e)
            ? (r.color.push(a), i.push(Rc), n.push(K.parse(e)))
            : e.startsWith(Bc)
              ? (r.var.push(a), i.push(zc), n.push(e))
              : (r.number.push(a), i.push(Lc), n.push(parseFloat(e))),
          ++a,
          Vc
        )
      )
...
function qe({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === Lc ? (i += Sc(r[a])) : e === Rc ? (i += K.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
function Ye(e) {
  let t = Ge(e);
  return qe(t)(t.values.map((e, n) => Wc(e, t.split[n])));
}
function Xe(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function mt(e = Y.visualDuration, t = Y.bounce) {
  ...
  let ee = {
    ...
    toString: () => {
      let e = Math.min(st(ee), Qc),
        t = Zc((t) => ee.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function _t(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = zs(Array.isArray(t) ? t[n] || I : t, a)), r.push(a));
  }
  return r;
}
...
function Tt(e) {
  typeof e.type == `string` && (e.type = ol[e.type]);
}
function Et(e) {
  return new ll(e);
}
...
function Mt() {
  if (Dl) {
    ...
    (t.forEach((e) => {
      ...
      e.forEach((e) => {
        e.suspendedScrollY !== void 0 && T.scrollTo(0, e.suspendedScrollY);
      }));
  }
  ((Dl = !1), (El = !1), Tl.forEach((e) => e.complete(Ol)), Tl.clear());
}
function Nt() {
  Tl.forEach((e) => {
...
function Ft(e, t, n) {
  Al(t) ? e.style.setProperty(t, n) : (e.style[t] = n);
}
function It(e, t) {
  let n = Pe(e);
  return () => jl[t] ?? n();
...
function Bt({ type: e, ...t }) {
  return zt(e) && Pl() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Vt(e) {
  return e in Rl;
}
function Ht(e) {
  typeof e.ease == `string` && Vt(e.ease) && (e.ease = Rl[e.ease]);
}
function Ut(e) {
  ((e.duration = 0), (e.type = `keyframes`));
}
function Wt(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == `string` && Hl.test(e[t])) return !0;
  return !1;
}
function Gt(e) {
  let {
...
function Qt(e) {
  for (let t in e) if (!au.has(t)) return !0;
  return !1;
}
function $t(e) {
  let t = su.exec(e);
...
function en(e, t, n = 1) {
  ...
  let [r, i] = $t(e);
  if (!r) return;
  let a = T.getComputedStyle(t).getPropertyValue(r);
  if (a) {
    let e = a.trim();
    return Is(e) ? parseFloat(e) : e;
  }
  return _c(i) ? en(i, t, n + 1) : i;
}
function tn(e) {
  let t = [{}, {}];
  return (
...
function pn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    let p = !1;
    if (T.MotionHandoffAnimation) {
      let n = dn(e);
      if (n) {
        let e = T.MotionHandoffAnimation(n, t, z);
        e !== null && ((o.startTime = e), (p = !0));
      }
    }
    ln(e, t);
    let m = l ?? e.shouldReduceMotion;
    r.start(ou(t, r, i, m && cu.has(t) ? { type: !1 } : o, e, p));
    let h = r.animation;
    h && d.push(h);
  }
  if (o) {
...
function vn(e, t) {
  let n = Cu(e);
  return (wu.has(n) || (n = q), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
function yn(e) {
  return typeof e == `number` ? e === 0 : e === null || e === `none` || e === `0` || Rs(e);
}
function bn(e, t, n) {
  let r = 0,
    i;
  for (; r < e.length && !i;) {
    let t = e[r];
    (typeof t == `string` && !Tu.has(t) && Ge(t).values.length && (i = e[r]), r++);
  }
...
function Sn(e) {
  return Ls(e) && `offsetHeight` in e && !(`ownerSVGElement` in e);
}
function Cn() {
  return Z.x || Z.y;
}
      ...
      let n = !1,
        ...
        c = (e) => {
          ((n = !1),
            ...
            T.removeEventListener(`pointercancel`, c),
            r && ((r = !1), s(e)));
        },
        l = () => {
          ((n = !0),
            T.addEventListener(`pointerup`, c, i),
            T.addEventListener(`pointercancel`, c, i));
        },
        u = (e) => {
...
function Nn(e, t, n = {}) {
  let [r, i, a] = Tn(e, n),
    o = (e) => {
      ...
      if (!Mn(e) || Lu.has(e)) return;
      (Fu.add(r), n.stopPropagation && Lu.add(e));
      let a = t(r, e),
        o = { ...i, capture: !0 },
        s = (e, t) => {
          (T.removeEventListener(`pointerup`, c, o),
            T.removeEventListener(`pointercancel`, l, o),
            Fu.has(r) && Fu.delete(r),
            Mn(e) && typeof a == `function` && a(e, { success: t }));
        },
        c = (e) => {
          s(e, r === T || r === document || n.useGlobalTarget || ju(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
      (T.addEventListener(`pointerup`, c, o), T.addEventListener(`pointercancel`, l, o));
    };
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? T : e).addEventListener(`pointerdown`, o, i),
        Sn(e) &&
          (e.addEventListener(`focus`, (e) => Iu(e, i)),
...
function Pn(e) {
  return Ls(e) && `ownerSVGElement` in e;
}
...
function Ln() {
  typeof ResizeObserver > `u` || (zu = new ResizeObserver(In));
}
function Rn(e, t) {
  zu || Ln();
  let n = xn(e);
  return (
    n.forEach((e) => {
      let n = Ru.get(e);
      (n || ((n = new Set()), Ru.set(e, n)), n.add(t), zu?.observe(e));
    }),
    () => {
      n.forEach((e) => {
        let n = Ru.get(e);
        (n?.delete(t), n?.size || zu?.unobserve(e));
      });
    }
  );
}
  ...
  return (
    ...
    () => {
      (Uu.delete(e),
        !Uu.size &&
          typeof Wu == `function` &&
          (T.removeEventListener(`resize`, Wu), (Wu = void 0)));
    }
  );
}
function Vn(e, t) {
...
function qn(e, t, n = {}) {
  ...
  if (
    (e.attach((e, t) => {
      ((a = e), (o = (e) => t(Jn(e, s))), z.postRender(u));
    }, c),
    X(t))
  ) {
...
function er(e) {
  return Qn(e.animate) || $u.some((t) => $n(e[t]));
}
function tr(e) {
...
function rr() {
  if (((td.current = !0), nd))
    if (T.matchMedia) {
      let e = T.matchMedia(`(prefers-reduced-motion)`),
...
function vr(e, t, n, r = !1) {
  ...
  (t.x < ld && t.x > cd && (t.x = 1), t.y < ld && t.y > cd && (t.y = 1));
}
function O(e, t) {
  ((e.min += t), (e.max += t));
}
function yr(e, t, n, r, i = 0.5) {
  gr(e, t, n, J(e.min, e.max, i), r);
}
function br(e, t) {
...
function wr(e, t, n) {
  ...
  return (
    a && ((i = !1), (r += `rotate(${Ou(a, _u.pathRotation)}) `)),
    (r = r.trim()),
...
function Or(e) {
  for (let t in e) ((md[t] = e[t]), hc(t) && (md[t].isCSSVariable = !0));
}
function kr(e, { layout: t, layoutId: n }) {
  return (
    bl.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!md[e] || e === `opacity`))
  );
}
function Ar(e, t, n) {
  let r = e.style,
...
function Pr(
  ...
  for (let e of yd) d[e] !== void 0 && ((f[e] = d[e]), delete d[e]);
  (t !== void 0 && (d.x = t),
    n !== void 0 && (d.y = n),
    r !== void 0 && (d.scale = r),
...
function Fr(e, t, n, r) {
  Er(e, t, void 0, r);
  for (let n in t.attrs) e.setAttribute(bd.has(n) ? n : un(n), t.attrs[n]);
}
function Ir(e, t, n) {
  let r = Ar(e, t, n);
  for (let n in e)
    if (X(e[n]) || X(t[n])) {
      let t = yl.indexOf(n) === -1 ? n : `attr` + n.charAt(0).toUpperCase() + n.substring(1);
      r[t] = e[n];
    }
  return r;
}
...
function qr(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.scale >= Dd && e.scale <= Od) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= Ad && e.translate <= jd) || isNaN(e.translate)) && (e.translate = 0));
}
function Jr(e, t, n, r) {
  (qr(e.x, t.x, n.x, r ? r.originX : void 0), qr(e.y, t.y, n.y, r ? r.originY : void 0));
}
function Yr(e, t, n, r = 0) {
  ((e.min = (r ? J(n.min, n.max, r) : n.min) + t.min), (e.max = e.min + A(t)));
}
function Xr(e, t, n, r) {
...
function ni(e, t, n, r) {
  (ti(e.x, t, Md, n ? n.x : void 0, r ? r.x : void 0),
    ti(e.y, t, Nd, n ? n.y : void 0, r ? r.y : void 0));
}
function ri(e) {
...
function fi(e, t, n, r, i, a) {
  i
    ? ((e.opacity = J(0, n.opacity ?? 1, Ld(r))), (e.opacityExit = J(t.opacity ?? 1, 0, Rd(r))))
  ...
  for (let i = 0; i < Pd; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || Id(o) === Id(s)
        ? ((e[a] = Math.max(J(Fd(o), Fd(s), r), 0)), (W.test(s) || W.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
...
function bi(e) {
  ...
  if (!t) return;
  let n = dn(t);
  if (T.MotionHasOptimisedAnimation(n, `transform`)) {
    let { layout: t, layoutId: r } = e.options;
    T.MotionCancelOptimisedAnimation(n, `transform`, z, !(t || r));
  }
  let { parent: r } = e;
...
function xi({
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Kd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            Gu.value && (Ud.nodes = Ud.calculatedTargetDeltas = Ud.calculatedProjections = 0),
            this.nodes.forEach(wi),
            this.nodes.forEach(Ni),
            this.nodes.forEach(Pi),
            this.nodes.forEach(Ti),
            Gu.addProjectionMetrics && Gu.addProjectionMetrics(Ud));
        }),
        ...
        (z.read(() => {
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              n && n(),
              (n = _i(i, 250)),
              Hd.hasAnimatedSinceResize &&
                ((Hd.hasAnimatedSinceResize = !1), this.nodes.forEach(Mi)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              let a = this.options.transition || i.getDefaultTransition() || qd,
    ...
    willUpdate(e = !0) {
      ...
      if (
        (T.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && bi(this),
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          Gu.value && Ud.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        Gu.value && Ud.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    createProjectionDeltas() {
      ((this.prevProjectionDelta = Yu()),
        (this.projectionDelta = Yu()),
        (this.projectionDeltaWithTransform = Yu()));
    }
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Gd), this.currentAnimation.stop()),
    ...
    registerSharedNode(e, t) {
      (this.sharedNodes.has(e) || this.sharedNodes.set(e, new Vd()),
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Wd.length; t++)
        (yi(`rotate${Wd[t]}`, e, r, this.animationValues),
          yi(`skew${Wd[t]}`, e, r, this.animationValues));
      e.render();
      for (let t in r)
    ...
    applyProjectionStyles(e, t) {
      ...
      for (let t in md) {
        ...
        let { correct: n, applyTo: o, isCSSVariable: s } = md[t],
...
function Yi({ children: e, isPresent: t, anchorX: i, anchorY: a, root: o, pop: s }) {
  let c = w(),
    u = l(null),
    d = l({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0, direction: `ltr` }),
    { nonce: f } = n($),
    p = Ji(u, e.props?.ref ?? e?.ref);
  return (
    r(() => {
...
function ta() {
  if (df) return;
  let e = {};
  for (let t in uf) e[t] = { isEnabled: (e) => uf[t].some((t) => !!e[t]) };
  (ir(e), (df = !0));
}
function na() {
  return (ta(), ar());
...
function aa(e) {
  typeof e == `function` && (pf = (t) => (t.startsWith(`on`) ? !ia(t) : e(t)));
}
function oa(e, t, n) {
  let r = {};
  for (let i in e)
...
function da(e) {
  let { initial: t, animate: r } = ua(e, n(mf));
  return v(() => ({ initial: t, animate: r }), [fa(t), fa(r)]);
}
function fa(e) {
...
function _a(e, t, n, r) {
  let i = v(() => {
    let n = vf();
    return (Pr(n, t, xd(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
    (pa(t, e.style, e), (i.style = { ...t, ...i.style }));
  }
  return i;
}
function va(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(yf.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
function ya(e, t, n, { latestValues: r }, i, a = !1, o) {
  let s = ((o ?? va(e)) ? _a : ga)(t, r, i, e),
    c = oa(t, typeof e == `string`, a),
    l = e === u ? {} : { ...c, ...s, ref: n },
    { children: d } = t,
    f = v(() => (X(d) ? d.get() : d), [d]);
...
function Sa(e, t, i, a, o, s) {
  let { visualElement: u } = n(mf),
    d = n(lf),
    f = n(Fs),
    p = n($),
    m = p.reducedMotion,
  ...
  let v = g.current,
    y = n(gf);
  v && !v.projection && o && (v.type === `html` || v.type === `svg`) && Ca(g.current, i, o, y);
  let b = l(!1);
  r(() => {
  ...
  let x = i[du],
    S = l(
      !!x && T !== void 0 && !T.MotionHandoffIsComplete?.(x) && T.MotionHasOptimisedAnimation?.(x)
    );
  return (
    N(() => {
      ((_.current = !0),
    ...
    c(() => {
      v &&
        ...
        (S.current &&=
          (queueMicrotask(() => {
            T.MotionHandoffMarkAsComplete?.(x);
          }),
          !1)),
...
function Ta(e, { forwardMotionProps: t = !1, type: r } = {}, i, a) {
  i && ra(i);
  let o = r ? r === `svg` : va(e),
    s = o ? xf : bf;
  function c(r, c) {
    ...
    if (!d && T !== void 0) {
      Da(u, i);
      let t = Oa(u);
      ((l = t.MeasureLayout), (f.visualElement = Sa(e, p, u, a, t.ProjectionNode, o)));
    }
    return b(mf.Provider, {
      value: f,
      children: [
        l && f.visualElement ? m(l, { visualElement: f.visualElement, ...u }) : null,
        ya(e, r, ba(p, f.visualElement, c), p, d, t, o),
      ],
    });
  }
...
function Wa(e, t) {
  let n = 0.5,
    ...
    i = A(t);
  return (
    i > r ? (n = Bs(t.min, t.max - r, e.min)) : r > i && (n = Bs(e.min, e.max - i, t.min)),
    P(0, 1, n)
  );
}
function Ga(e, t) {
...
function $a(e) {
  let [t, r] = Zi(),
    i = n(Ns);
  return m(Bf, { ...e, layoutGroup: i, switchLayoutGroup: n(gf), isPresent: t, safeToRemove: r });
}
function eo(e, t, n) {
  let { props: r } = e;
  e.animationState && r.whileHover && e.animationState.setActive(`whileHover`, n === `Start`);
  let i = r[`onHover` + n];
  i && z.postRender(() => i(t, Aa(t)));
}
function to(e, t, n) {
  let { props: r } = e;
...
function no({ root: e, ...t }) {
  ...
  let r = Kf.get(n),
    i = JSON.stringify(t);
  return (r[i] || (r[i] = new IntersectionObserver(Jf, { root: e, ...t })), r[i]);
}
function ro(e, t, n) {
  let r = no(t);
  return (
...
function oo(e, t, n, r) {
  ...
  ((i.current = Math.abs(e[`scroll${o}`])),
    ...
    (i.progress = Bs(0, i.scrollLength, i.current)));
  let l = r - c;
  i.velocity = l > tp ? 0 : Hs(i.current - s, l);
}
function so(e, t, n) {
  (oo(e, `x`, t, n), oo(e, `y`, t, n), (t.time = n));
}
function co(e, t) {
  let n = { x: 0, y: 0 },
    r = e;
...
function lo(e, t, n = 0) {
  let r = 0;
  if ((e in ap && (e = ap[e]), typeof e == `string`)) {
    let t = parseFloat(e);
    e.endsWith(`px`)
      ? (r = t)
      : e.endsWith(`%`)
...
function uo(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ? (i = [e, e])
      : typeof e == `string` &&
        ((e = e.trim()), (i = e.includes(` `) ? e.split(` `) : [e, ap[e] ? e : `0`])),
    (a = lo(i[0], n, r)),
    (o = lo(i[1], t)),
    a - o
  );
...
function po(e, t, n) {
  let { offset: r = sp.All } = n,
    { target: i = e, axis: a = `y` } = n,
    o = a === `y` ? `height` : `width`,
    s = i === e ? cp : co(i, e),
    c = i === e ? { width: e.scrollWidth, height: e.scrollHeight } : fo(i),
    l = { width: e.clientWidth, height: e.clientHeight };
  t[a].offset.length = 0;
  let u = !t[a].interpolate,
    d = r.length;
  for (let e = 0; e < d; e++) {
    let n = uo(r[e], l[o], c[o], s[a]);
...
function ho(e, t, n, r = {}) {
  return {
    measure: (t) => {
      (mo(e, r.target, n), so(e, n, t), (r.offset || r.target) && po(e, n, r));
    },
    notify: () => t(n),
  };
}
function go(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !lp.has(t))) {
    ...
    (T.addEventListener(`resize`, r),
      t !== document.documentElement && up.set(t, Vn(t, r)),
  ...
  return (
    ...
    () => {
      ...
      (lp.delete(t),
        n &&
          (mp(t).removeEventListener(`scroll`, n),
          up.get(t)?.(),
          T.removeEventListener(`resize`, n)));
      let r = pp.get(t);
      (r && (B(r), pp.delete(t)), fp.delete(t));
    }
  );
}
function _o(e) {
  return T === void 0 ? !1 : e ? Nl() : Ml();
}
function vo(e) {
...
function xo(e) {
  ...
  for (let [t, n] of hp) if (bo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function So(e) {
  let t = { value: 0 };
  return {
...
function Co({ source: e, container: t, ...n }) {
  let { axis: r } = n;
  e && (t = e);
  let i = _p.get(t);
  i || ((i = new Map()), _p.set(t, i));
  let a = n.target ?? `self`,
    o = i.get(a);
  o || ((o = {}), i.set(a, o));
...
function wo(e, t) {
  let n = Co(t),
    r = t.target ? xo(t.offset) : void 0,
    i = t.target ? _o(t.target) && !!r : _o();
...
function Oo(e, { axis: t = `y`, container: n = document.scrollingElement, ...r } = {}) {
  if (!n) return I;
  let i = { axis: t, container: n, ...r };
  return typeof e == `function` ? Do(e, i) : wo(e, i);
}
function ko(e, t, n, r) {
  return {
    factory: (i) => {
...
function Ao(e, t) {
  return T === void 0 ? !1 : e ? Nl() && !!xo(t) : Ml();
}
function jo({ container: e, target: t, ...n } = {}) {
  let r = M(vp);
  Ao(t, n.offset) &&
    ((r.scrollXProgress.accelerate = ko(`x`, n, e, t)),
    (r.scrollYProgress.accelerate = ko(`y`, n, e, t)));
  let i = l(null),
    a = l(!1),
    o = s(
      () => (
...
function Po(e) {
  ((Ql.current = []), e());
  let t = No(Ql.current, e);
  return ((Ql.current = void 0), t);
}
function Fo(e, t, n, r) {
  if (typeof e == `function`) return Po(e);
  if (n !== void 0 && !Array.isArray(n) && typeof t != `function`) return Lo(e, t, n, r);
  let i = typeof t == `function` ? t : Kn(t, n, r),
    a = Array.isArray(e) ? Io(e, i) : Io([e], ([e]) => i(e)),
...
function Lo(e, t, n, r) {
  let i = M(() => Object.keys(n)),
    a = M(() => ({}));
  for (let o of i) a[o] = Fo(e, t, n[o], r);
  return a;
}
function Ro(e, t = {}) {
  let { isStatic: i } = n($),
  ...
  if (i) return Fo(a);
  let o = Mo(a());
  return (r(() => qn(o, e, t), [o, JSON.stringify(t)]), o);
}
function zo(e, t = {}) {
  return Ro(e, { type: `spring`, ...t });
}
function Bo(e) {
  let t = l(0),
    { isStatic: r } = n($);
...
function Qo(e, t, n, r, i, a) {
  Zo(e, i, a);
  for (let o = 0; o < t.length; o++) e.push({ value: t[o], at: J(i, a, r[o]), easing: Le(n, o) });
}
function $o(e, t, n = 0) {
  let r = t + 1 + t * n;
...
function ts(e, { defaultTransition: t = {}, ...n } = {}, r, i) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    if (typeof o == `string`) {
      ...
      l.set(o.name, Xo(d, o.at, u, l));
      continue;
    }
    let [p, m, h = {}] = o;
    h.at !== void 0 && (d = Xo(d, h.at, u, l));
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        let c = is(e),
          {
        ...
        if (
          (ee > 0 && yt(u, ee), c.length === 1 && c.unshift(null), m && `${m}${Sp}`, m && m < Sp)
        ) {
          let e = b > 0 ? _ / b : 0;
          b = Yo(b, m, _);
          let t = [...c],
          ...
          i &&
            ((a = [...t].reverse()),
            h === `reverse` &&
              (o = [...r].reverse().map((e) => (typeof e == `function` ? Js(e) : e))));
          for (let s = 0; s < m; s++) {
            let l = i && s % 2 == 0,
              d = l ? a : t,
              f = l ? o : r,
        ...
        let T = w + b;
        (Qo(r, c, y, u, w, T), (g = Math.max(x + b, g)), (f = Math.max(T, f)));
      };
    if (X(p)) {
      let e = ns(p, s);
      _(m, h, rs(`default`, e));
      ...
      for (let n = 0; n < t; n++) {
        ...
        let r = e[n],
          i = ns(r, s);
        for (let e in m) _(m[e], as(h, e), rs(e, i), n, t);
      }
    }
    ((u = d), (d += g));
  }
    ...
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        for (let e = 0; e < a.length; e++) {
          ...
          (s.push(n), c.push(Bs(0, f, t)), l.push(r || `easeOut`));
        }
        (c[0] !== 0 && (c.unshift(0), s.unshift(s[0]), l.unshift(xp)),
...
function cs(e, t) {
  return X(e) || typeof e == `number` || (typeof e == `string` && !qo(t));
}
function ls(e, t, n, r) {
  let i = [];
  if (cs(e, t)) i.push(hi(e, (qo(t) && t.default) || t, n && (n.default || n)));
  else {
    if (e == null) return i;
    let a = Jo(e, t, r),
      o = a.length;
...
function fs(e = {}) {
  ...
  function i(e, i, a) {
    let o = [],
      s,
      c = {};
    if ((n !== void 0 && (c.reduceMotion = n), r !== void 0 && (c.skipAnimations = r), ds(e))) {
      let { onComplete: n, ...r } = i || {};
      (typeof n == `function` && (s = n), (o = us(e, { ...c, ...r }, t)));
    } else {
      let { onComplete: n, ...r } = a || {};
      (typeof n == `function` && (s = n), (o = ls(e, i, { ...c, ...r }, t)));
    }
    let l = new Yl(o);
    return (
      s && l.finished.then(s),
...
function ms(e) {
  return typeof e == `object` && !!e && Sf in e;
}
function hs(e) {
  if (ms(e)) return e[Sf];
}
...
function _s(e) {
  Qd.current && ((Qd.current.isUpdating = !1), Qd.current.blockUpdate(), e && e());
}
function vs() {
  return s(() => {
    let e = Qd.current;
...
function ys(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
  let a = xn(e),
    o = new WeakMap(),
    s = new IntersectionObserver(
      ...
      { root: n, rootMargin: r, threshold: typeof i == `number` ? i : Dp[i] }
    );
  return (a.forEach((e) => s.observe(e)), () => s.disconnect());
}
function bs(e, { root: t, margin: n, amount: r, once: a = !1, initial: o = !1 } = {}) {
  let [s, l] = i(o);
  return (
    c(() => {
...
function ws({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  let s = M(() => $f[t]),
    u = [],
    d = l(!1),
    f = l(null),
    p = {
      ...
      registerItem: (e, t) => {
        ...
        (r === -1 ? u.push({ value: e, layout: t[n] }) : (u[r].layout = t[n]), u.sort(Ts));
      },
      updateOrder: (e, t, n) => {
        if (d.current) return;
        let a = Cs(u, e, t, n);
  ...
  return m(s, {
    ...
    ref: h,
    ignoreStrict: !0,
    children: m(Ap.Provider, { value: p, children: e }),
  });
}
function Ts(e, t) {
...
function Es() {
  if (Lp) {
    let e = Os(Lp, `y`);
    e && (Ip.delete(e), Fp.delete(e));
    let t = Os(Lp, `x`);
    (t && t !== e && (Ip.delete(t), Fp.delete(t)), (Lp = null));
  }
}
function Ds(e, t) {
...
function ks(e, t, n) {
  let r = t.getBoundingClientRect(),
    ...
    a = n === `x` ? Math.min(T.innerWidth, r.right) : Math.min(T.innerHeight, r.bottom),
    o = e - i,
    s = a - e;
  if (o < Mp) {
    let e = 1 - o / Mp;
    return { amount: -Np * e * e, edge: `start` };
  } else if (s < Mp) {
    let e = 1 - s / Mp;
    return { amount: Np * e * e, edge: `end` };
  }
...
function As(e, t, n, r) {
  ...
  let i = Os(e, n);
  if (!i) return;
  let { amount: a, edge: o } = ks(t - (n === `x` ? T.scrollX : T.scrollY), i, n);
  if (o === null) {
    (Ip.delete(i), Fp.delete(i));
    return;
  }
  let s = Ip.get(i),
  ...
  if (s !== o) {
    ...
    let e =
      n === `x`
        ? i.scrollWidth - (c ? T.innerWidth : i.clientWidth)
        : i.scrollHeight - (c ? T.innerHeight : i.clientHeight);
    Fp.set(i, e);
  }
  if (a > 0) {
    let e = Fp.get(i);
    if ((n === `x` ? (c ? T.scrollX : i.scrollLeft) : c ? T.scrollY : i.scrollTop) >= e) return;
  }
  n === `x`
    ? c
      ? T.scrollBy({ left: a })
  ...
  return m(u, {
    ...
    onDrag: (e, t) => {
      let { velocity: n, point: i } = t,
        o = f[h].get();
      (_(r, o, n[h]), As(v.current, i[h], h, n[h]), a && a(e, t));
    },
    onDragEnd: (e, t) => {
      (Es(), o && o(e, t));
    },
...
var Ns,
  ...
  zp = t(() => {
    (o(),
      ...
      (F = {}),
      (Is = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e)),
      (Ls = (e) => typeof e == `object` && !!e),
      (Rs = (e) => /^0[^.\s]+$/u.test(e)),
      (I = (e) => e),
      (zs = (...e) => e.reduce((e, t) => (n) => t(e(n)))),
      (Bs = (e, t, n) => {
        let r = t - e;
        return r ? (n - e) / r : 1;
      }),
      ...
      (Ws = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e),
      (Gs = 1e-7),
      (Ks = 12),
      (qs = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2)),
      (Js = (e) => (t) => 1 - e(1 - t)),
      (Ys = Ie(0.33, 1.53, 0.69, 0.99)),
      (Xs = Js(Ys)),
      (Zs = qs(Xs)),
      (Qs = (e) => (e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * Xs(e) : 0.5 * (2 - 2 ** (-10 * (e - 1))))),
      ...
      (rc = Ie(0, 0, 0.58, 1)),
      (ic = Ie(0.42, 0, 0.58, 1)),
      (ac = (e) => Array.isArray(e) && typeof e[0] != `number`),
      ...
      (cc = (e) => typeof e == `string`),
      (lc = (e) => {
        if (oc(e)) {
          e.length;
          let [t, n, r, i] = e;
          return Ie(t, n, r, i);
        } else if (cc(e)) return (sc[e], `${e}`, sc[e]);
        return e;
      }),
      (uc = [
        `setup`,
      ...
      ({
        ...
        state: V,
        steps: fc,
      } = ze(typeof requestAnimationFrame < `u` ? requestAnimationFrame : I, !0)),
      (H = {
        now: () => (
          pc === void 0 &&
        ...
        set: (e) => {
          ((pc = e), queueMicrotask(Be));
        },
      }),
      (mc = (e) => (t) => typeof t == `string` && t.startsWith(e)),
      (hc = mc(`--`)),
      (gc = mc(`var(--`)),
      (_c = (e) => (gc(e) ? vc.test(e.split(`/*`)[0].trim()) : !1)),
      (vc = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu),
      (yc = { test: (e) => typeof e == `number`, parse: parseFloat, transform: (e) => e }),
      (bc = { ...yc, transform: (e) => P(0, 1, e) }),
      (xc = { ...yc, default: 1 }),
      (Sc = (e) => Math.round(e * 1e5) / 1e5),
      (Cc = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu),
      (wc =
        /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu),
      (Tc = (e, t) => (n) =>
        !!(
          (typeof n == `string` && wc.test(n) && n.startsWith(e)) ||
          (t && !He(n) && Object.prototype.hasOwnProperty.call(n, t))
        )),
      (Ec = (e, t, n) => (r) => {
        if (typeof r != `string`) return r;
        let [i, a, o, s] = r.match(Cc);
        return {
          [e]: parseFloat(i),
          [t]: parseFloat(a),
          [n]: parseFloat(o),
      ...
      (Dc = (e) => P(0, 255, e)),
      (Oc = { ...yc, transform: (e) => Math.round(Dc(e)) }),
      (kc = {
        test: Tc(`rgb`, `red`),
      ...
      (Ac = { test: Tc(`#`), parse: Ue, transform: kc.transform }),
      (jc = (e) => ({
      ...
      (Mc = jc(`vh`)),
      (Nc = jc(`vw`)),
      (Pc = { ...W, parse: (e) => W.parse(e) / 100, transform: (e) => W.transform(e * 100) }),
      (Fc = {
        test: Tc(`hsl`, `hue`),
      ...
      (K = {
        test: (e) => kc.test(e) || Ac.test(e) || Fc.test(e),
        parse: (e) => (kc.test(e) ? kc.parse(e) : Fc.test(e) ? Fc.parse(e) : Ac.parse(e)),
        transform: (e) =>
          typeof e == `string` ? e : e.hasOwnProperty(`red`) ? kc.transform(e) : Fc.transform(e),
        getAnimatableNone: (e) => {
          let t = K.parse(e);
      ...
      (Uc = (e) => (typeof e == `number` ? 0 : K.test(e) ? K.getAnimatableNone(e) : e)),
      (Wc = (e, t) => (typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : Uc(e))),
      (q = { test: We, parse: Ke, createTransformer: Je, getAnimatableNone: Ye }),
      (J = (e, t, n) => e + (t - e) * n),
      (Gc = (e, t, n) => {
        let r = e * e,
          i = n * (t * t - r) + r;
      ...
      (Jc = (e, t) => {
        ...
        let i = { ...n };
        return (e) => (
          (i.red = Gc(n.red, r.red, e)),
          (i.green = Gc(n.green, r.green, e)),
          (i.blue = Gc(n.blue, r.blue, e)),
      ...
      (ol = { decay: gt, inertia: gt, tween: Ct, keyframes: Ct, spring: mt }),
      (sl = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (ll = class extends sl {
        ...
        initAnimation() {
          ...
          s !== Ct &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = zs(cl, ot(o[0], o[1]))), (o = [0, 100]));
        ...
        play() {
          ...
          let { driver: e = al, startTime: t } = this.options;
      ...
      (fl = {
        ...
        rotate: dl,
        rotateZ: dl,
        skewX: (e) => ul(Math.atan(e[1])),
        skewY: (e) => ul(Math.atan(e[2])),
        skew: (e) => (Math.abs(e[1]) + Math.abs(e[2])) / 2,
      }),
      (pl = (e) => ((e %= 360), e < 0 && (e += 360), e)),
      (ml = dl),
      (hl = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1])),
      (gl = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5])),
      (_l = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: gl,
        scale: (e) => (hl(e) + gl(e)) / 2,
        rotateX: (e) => pl(ul(Math.atan2(e[6], e[5]))),
        rotateY: (e) => pl(ul(Math.atan2(-e[2], e[0]))),
        rotateZ: ml,
        rotate: ml,
        skewX: (e) => ul(Math.atan(e[4])),
        skewY: (e) => ul(Math.atan(e[1])),
      ...
      (bl = new Set([...yl, `pathRotation`])),
      (xl = (e) => e === yc || e === G),
      (Sl = new Set([`x`, `y`, `z`])),
      (Cl = yl.filter((e) => !Sl.has(e))),
      (wl = {
      ...
      (kl = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Tl.add(this), El || ((El = !0), z.read(Nt), z.resolveKeyframes(Mt)))
        ...
        cancel() {
          this.state === `scheduled` && (Tl.delete(this), (this.state = `pending`));
        }
        resume() {
      ...
      (Al = (e) => e.startsWith(`--`)),
      (jl = {}),
      (Ml = It(() => T.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Nl = It(() => T.ViewTimeline !== void 0, `viewTimeline`)),
      (Pl = It(() => {
        try {
      ...
      (Fl = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`),
      (Il = {
        linear: `linear`,
        ease: `ease`,
        easeIn: `ease-in`,
      ...
      (Rl = { anticipate: Qs, backInOut: Zs, circInOut: tc }),
      (zl = 10),
      (Bl = class extends Ll {
        constructor(e) {
          (Ht(e),
        ...
        updateMotionValue(e) {
          ...
          let o = new ll({ ...a, autoplay: !1 }),
            s = Math.max(zl, H.now() - this.startTime),
            c = P(0, zl, s - zl),
            l = o.sample(s).value,
            { name: u } = this.options;
          (i && u && Ft(i, u, l),
      ...
      (Vl = new Set([`opacity`, `clipPath`, `filter`, `transform`])),
      (Hl = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/),
      (Ul = new Set([
        `color`,
        `backgroundColor`,
        `outlineColor`,
      ...
      (Wl = Pe(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Gl = (e, t) =>
        t !== `zIndex` &&
        !!(
          typeof e == `number` ||
      ...
      (ql = class extends sl {
        ...
        onKeyframesResolved(e, t, n, r) {
          ...
          qt(e, i, a, o) ||
            ((u = !1),
            (F.instantAnimations || !s) && l?.(wt(e, n, t)),
            (e[0] = e[e.length - 1]),
            Ut(n),
            (n.repeat = 0));
          let d = {
              startTime: r
                ? this.resolvedAt && this.resolvedAt - this.createdAt > Kl
                  ? this.resolvedAt
                  : this.createdAt
                : void 0,
              finalKeyframe: t,
      ...
      ($l = class {
        ...
        get() {
          return (Ql.current && Ql.current.push(this), this.current);
        }
        getPrevious() {
          return this.prev;
        }
        getVelocity() {
          let e = H.now();
          if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > Xl)
            return 0;
          let t = Math.min(this.updatedAt - this.prevUpdatedAt, Xl);
          return Hs(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
        }
        start(e) {
          return (
            this.stop(),
      ...
      (iu = (e, { keyframes: t }) =>
        t.length > 2 ? nu : bl.has(e) ? (e.startsWith(`scale`) ? tu(t[1]) : eu) : ru),
      (au = new Set([
        `when`,
        `delay`,
        `delayChildren`,
      ...
      (ou =
        ...
        (o) => {
          ...
          return s.isSync ? new ll(u) : new ql(u);
        }),
      (su = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u),
      (cu = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...yl])),
      (lu = (e) => Array.isArray(e)),
      (X = (e) => !!(e && e.getVelocity)),
      (uu = `framerAppearId`),
      (du = `data-` + un(uu)),
      (fu = (e) => (t) => t.test(e)),
      (pu = [yc, G, W, U, Nc, Mc, { test: (e) => e === `auto`, parse: (e) => e }]),
      (mu = (e) => pu.find(fu(e))),
      (hu = {
        rotate: U,
        pathRotation: U,
      ...
      (vu = new Set([`brightness`, `contrast`, `saturate`, `opacity`])),
      (yu = /\b([a-z-]*)\(.*?\)/gu),
      (bu = {
        ...q,
        getAnimatableNone: (e) => {
      ...
      (Eu = class extends kl {
        ...
        readKeyframes() {
          ...
          for (let n = 0; n < e.length; n++) {
            let r = e[n];
            if (typeof r == `string` && ((r = r.trim()), _c(r))) {
          ...
          if (a !== o)
            ...
            else wl[n] && (this.needsMeasurement = !0);
        }
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = T.pageYOffset),
            (this.measuredOrigin = wl[n](e.measureViewportBox(), T.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = wl[t](e.measureViewportBox(), T.getComputedStyle(e.current))),
      ...
      [...Du],
      (Ou = (e, t) => (t && typeof e == `number` ? t.transform(e) : e)),
      ({ schedule: ku, cancel: Au } = ze(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      (ju = (e, t) => (t ? e === t || ju(e, t.parentElement) : !1)),
      (Mu = (e) =>
        e.pointerType === `mouse`
          ? typeof e.button != `number` || e.button <= 0
          : e.isPrimary !== !1),
      (Nu = new Set([`BUTTON`, `INPUT`, `SELECT`, `TEXTAREA`, `A`])),
      (Pu = new Set([`INPUT`, `SELECT`, `TEXTAREA`])),
      (Fu = new WeakSet()),
      (Iu = (e, t) => {
      ...
      (Vu = Bu(`inline`, `width`, `offsetWidth`)),
      (Hu = Bu(`block`, `height`, `offsetHeight`)),
      (Uu = new Set()),
      (Gu = { value: null, addProjectionMetrics: null }),
      (Ku = [...pu, K, q]),
      (qu = (e) => Ku.find(fu(e))),
      (Ju = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 })),
      (Yu = () => ({ x: Ju(), y: Ju() })),
      (Xu = () => ({ min: 0, max: 0 })),
      (Q = () => ({ x: Xu(), y: Xu() })),
      (Zu = new WeakMap()),
      ...
      (ad = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (td.current || rr(), (this.shouldReduceMotion = ed.current)),
        ...
        bindToMotionValue(e, t) {
          if (
            ...
            t.accelerate && Vl.has(e) && this.current instanceof HTMLElement)
          ) {
          ...
          let r = t.on(`change`, (t) => {
            ...
            i;
          (T !== void 0 && T.MotionCheckAppearSync && (i = T.MotionCheckAppearSync(this, e, t)),
            this.valueSubscriptions.set(e, () => {
              (r(), i && i());
            }));
        }
        ...
        readValue(e, t) {
          ...
          return (
            n != null &&
              (typeof n == `string` && (Is(n) || Rs(n))
                ? (n = parseFloat(n))
                : !qu(n) && q.test(t) && (n = vn(e, t)),
        ...
        on(e, t) {
          return (this.events[e] || (this.events[e] = new Vs()), this.events[e].add(t));
        }
        notify(e, ...t) {
      ...
      (hd = class extends od {
        ...
        readValueFromInstance(e, t) {
          if (bl.has(t)) return this.projection?.isProjecting ? Ot(t) : vl(e, t);
          {
            let n = jr(e),
              r = (hc(t) ? n.getPropertyValue(t) : n[t]) || 0;
      ...
      (_d = { offset: `stroke-dashoffset`, array: `stroke-dasharray` }),
      (vd = { offset: `strokeDashoffset`, array: `strokeDasharray` }),
      (yd = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`]),
      (bd = new Set([
        `baseFrequency`,
        `diffuseConstant`,
        `kernelMatrix`,
      ...
      (Sd = class extends od {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = bd.has(t) ? t : un(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Ir(e, t, n);
        }
        ...
        mount(e) {
          ((this.isSVGTag = xd(e.tagName)), super.mount(e));
        }
      }),
      (Cd = $u.length),
      (wd = [...Qu].reverse()),
      ...
      (Nd = [`y`, `scaleY`, `originY`]),
      (Pd = Du.length),
      (Fd = (e) => (typeof e == `string` ? parseFloat(e) : e)),
      (Id = (e) => typeof e == `number` || G.test(e)),
      (Ld = mi(0, 0.5, ec)),
      (Rd = mi(0.5, 0.95, I)),
      (zd = (e, t) => e.depth - t.depth),
      (Bd = class {
        constructor() {
        ...
        forEach(e) {
          (this.isDirty && this.children.sort(zd), (this.isDirty = !1), this.children.forEach(e));
        }
      }),
      (Vd = class {
        constructor() {
      ...
      (Hd = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 }),
      (Ud = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 }),
      (Wd = [``, `X`, `Y`, `Z`]),
      (Gd = 1e3),
      (Kd = 0),
      (qd = { duration: 0.45, ease: [0.4, 0, 0.1, 1] }),
      (Jd = (e) => d !== void 0 && d.userAgent && d.userAgent.toLowerCase().includes(e)),
      (Yd = Jd(`applewebkit/`) && !Jd(`chrome/`) ? Math.round : I),
      (Xd = xi({
      ...
      (Zd = (e) => !e.isLayoutDirty && e.willUpdate(!1)),
      (Qd = { current: void 0 }),
      ($d = xi({
        ...
        defaultParent: () => {
          if (!Qd.current) {
            let e = new Xd({});
            (e.mount(T), e.setOptions({ layoutScroll: !0 }), (Qd.current = e));
          }
          return Qd.current;
        },
        resetTransform: (e, t) => {
        ...
        checkIsScrollRoot: (e) => T.getComputedStyle(e).position === `fixed`,
      })),
      uc.reduce((e, t) => ((e[t] = (e) => B(e)), e), {}),
      ...
      (tf = ({
        ...
        return (
          ...
          m(Fs.Provider, { value: y, children: e })
        );
      }),
      (nf = (e) => e.key || ``),
      (rf = ({
      ...
      (of = (e) => e === !0),
      (sf = (e) => of(e === !0) || e === `id`),
      (cf = ({ children: e, id: t, inherit: r = !0 }) => {
        let i = n(Ns),
          a = n(af),
          [o, s] = ea(),
          c = l(null),
        ...
        c.current === null &&
          (sf(r) && u && (t = t ? u + `-` + t : u),
          (c.current = { id: t, group: (of(r) && i.group) || Gi() }));
        let d = v(() => ({ ...c.current, forceRender: o }), [s]);
        return m(Ns.Provider, { value: d, children: e });
      }),
      (lf = a({ strict: !1 })),
      (uf = {
        animation: [
    ...
    ((mf = a({})),
      ...
      (gf = a({})),
      (_f = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} })),
      (vf = () => ({ ..._f(), attrs: {} })),
      (yf = [
        `animate`,
        `circle`,
      ...
      (bf = hf({ scrapeMotionValuesFromProps: Ar, createRenderState: _f })),
      (xf = hf({ scrapeMotionValuesFromProps: Ir, createRenderState: vf })),
      ...
      (Tf = class extends sd {
        constructor() {
          (super(...arguments), (this.id = wf++), (this.isExitComplete = !1));
        }
        update() {
      ...
      (Ef = { animation: { Feature: Cf }, exit: { Feature: Tf } }),
      (Df = (e) => (t) => Mu(t) && e(t, Aa(t))),
      (Of = (e, t) => Math.abs(e - t)),
      (kf = (e, t) => ((t.isSVG ?? va(e)) ? new Sd(t) : new hd(t, { allowProjection: e !== u }))),
      (Af = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
      (jf = new Set([`auto`, `scroll`])),
      (Mf = class {
        constructor(
          e,
          t,
        ...
        startScrollTracking(e) {
          ...
          for (; t;) {
            ...
            ((jf.has(e.overflowX) || jf.has(e.overflowY)) &&
              this.scrollPositions.set(t, { x: t.scrollLeft, y: t.scrollTop }),
              (t = t.parentElement));
          }
          (this.scrollPositions.set(T, { x: T.scrollX, y: T.scrollY }),
            T.addEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
            T.addEventListener(`scroll`, this.onWindowScroll),
            (this.removeScrollListeners = () => {
              (T.removeEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
                T.removeEventListener(`scroll`, this.onWindowScroll));
            }));
        }
        handleScroll(e) {
          ...
          if (!t) return;
          let n = e === T,
            r = n ? { x: T.scrollX, y: T.scrollY } : { x: e.scrollLeft, y: e.scrollTop },
      ...
      (Ff = class {
        ...
        start(e, { snapToCursor: t = !1, distanceThreshold: n } = {}) {
          ...
          this.panSession = new Mf(
            ...
            { onSessionStart: i, onStart: a, onMove: o, onSessionEnd: s, resumeAnimation: c },
            {
              ...
              dragSnapToOrigin: l,
              distanceThreshold: n,
              contextWindow: Af(this.visualElement),
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (ln(this.visualElement, e), n.start(ou(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        addListeners() {
          if (!this.visualElement.current) return;
          Pf.set(this.visualElement, this);
          ...
          let o = gi(T, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (Rf = class extends sd {
        ...
        onPointerDown(e) {
          this.session = new Mf(e, this.createPanHandlers(), {
            transformPagePoint: this.node.getTransformPagePoint(),
            contextWindow: Af(this.node),
          });
        }
        createPanHandlers() {
      ...
      (Vf = { pan: { Feature: Rf }, drag: { Feature: If, ProjectionNode: $d, MeasureLayout: $a } }),
      (Hf = class extends sd {
        mount() {
      ...
      (Qf = { layout: { ProjectionNode: $d, MeasureLayout: $a } }),
      ($f = ka({ ...Ef, ...Zf, ...Vf, ...Qf }, kf)),
      (ep = { renderer: kf, ...Ef, ...Zf }),
      { ...ep, ...Vf, ...Qf },
      { ...Ef },
      (tp = 50),
      (np = () => ({
      ...
      (rp = () => ({ time: 0, x: np(), y: np() })),
      (ip = { x: { length: `Width`, position: `Left` }, y: { length: `Height`, position: `Top` } }),
      (ap = { start: 0, center: 0.5, end: 1 }),
      (op = [0, 0]),
      (sp = {
        Enter: [
          [0, 1],
      ...
      (fp = new WeakMap()),
      (pp = new WeakMap()),
      (mp = (e) => (e === document.scrollingElement ? T : e)),
      (hp = [
        [sp.Enter, `entry`],
        [sp.Exit, `exit`],
        [sp.Any, `cover`],
      ...
      (gp = { start: 0, end: 1 }),
      (_p = new Map()),
      (vp = () => ({ scrollX: D(0), scrollY: D(0), scrollXProgress: D(0), scrollYProgress: D(0) })),
      (yp = (e) => (e ? !e.current : !1)),
      (bp = class extends $l {
        constructor() {
        ...
        add(e) {
          (bl.has(e) || Vl.has(e)) && ((this.isEnabled = !0), this.update());
        }
        update() {
      ...
      (Dp = { some: 0, all: 1 }),
      (Op = () => ({})),
      hf({ scrapeMotionValuesFromProps: Op, createRenderState: Op }),
      (kp = {}),
      fe(kp, { Group: () => jp, Item: () => Rp }),
      (Ap = a(null)),
      (jp = _(ws)),
      (Mp = 50),
      (Np = 25),
      (Pp = new Set([`auto`, `scroll`])),
      (Fp = new WeakMap()),
      (Ip = new WeakMap()),
      (Lp = null),
      (Rp = _(Ms)));
...
function Vp(e) {
  ...
  switch (i) {
    ...
    case 1:
      ((t ^= 255 & e.charCodeAt(r)), (t = 1540483477 * (65535 & t) + ((59797 * (t >>> 16)) << 16)));
  }
  return (
    (t ^= t >>> 13),
...
//# sourceMappingURL=motion.C18vkCAc.mjs.map
